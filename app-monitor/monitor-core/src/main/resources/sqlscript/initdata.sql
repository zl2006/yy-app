...
UPDATE `TB_MONITOR_ENTITY` SET `MONITOR_ENTITY_CFG`='{\"icon\":\"http://localhost:8080/monitor-console//resources/images/1.png\"}' WHERE `CFG_ID`='1';
UPDATE `TB_MONITOR_ENTITY` SET `MONITOR_ENTITY_CFG`='{\"icon\":\"http://localhost:8080/monitor-console//resources/images/2.png\"}' WHERE `CFG_ID`='2';
UPDATE `TB_MONITOR_ENTITY` SET `MONITOR_ENTITY_CFG`='{\"icon\":\"http://localhost:8080/monitor-console//resources/images/3.png\"}' WHERE `CFG_ID`='3';
