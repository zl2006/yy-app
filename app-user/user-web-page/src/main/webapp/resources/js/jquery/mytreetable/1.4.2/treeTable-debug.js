...
*/
define("jquery/mytreetable/1.4.2/treeTable-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    module.exports = $;
    (function($) {
	...
	if (document.location.href.indexOf('http://') != 0)	{
        ...
        $.fn.treeTable = function(opts) {
            ...
            if ($("head").find("#tree_table_" + opts.theme).length == 0) {
                $("head").append('<link id="tree_table_' + opts.theme + '" href="' + path + opts.theme + '/treeTable.css" rel="stylesheet" type="text/css" />');
            }
            var css = {
                N: opts.theme + "_node",
