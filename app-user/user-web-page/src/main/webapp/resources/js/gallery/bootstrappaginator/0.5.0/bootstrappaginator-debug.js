define("gallery/bootstrappaginator/0.5.0/bootstrappaginator-debug", [ "$-debug", "gallery/bootstrap/3.0.0/bootstrap-debug.js" ], function(require, exports, module) {
    /**
 ...
 */
    var $ = require("$-debug");
    require("gallery/bootstrap/3.0.0/bootstrap-debug.js");
    module.exports = $;
    (function($) {
        "use strict";
        // jshint ;_;
     ...
     * */
         ...
         * */
            render: function() {
                ...
                if (this.options.bootstrapMajorVersion === 3) {
                    switch (alignment.toLowerCase()) {
                      case "left":
                        this.$element.addClass("pull-left");
                        break;
         ...
         * */
            getPages: function() {
                ...
                //check the range of the page start to see if its less than 1.
                ...
                output.first = 1;
                //add the first when the current page leaves the 1st page.
                ...
                // add the last page when the current page doesn't reach the last page
