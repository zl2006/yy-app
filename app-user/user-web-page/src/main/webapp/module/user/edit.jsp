				...
				<div class="bs-docs-section">
					<div class="page-header">
						...
						<div class="bs-example" style="content:">
							<form role="form" class="form-horizontal" action="${basePath }/user/edit.json?resID=${param.resID}"
								method="post" id="save_update_form">
								<input type="hidden" name="userID" value="${data.userID }"/>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="loginID">登录ID:</label>
									<div class="col-sm-3">
										<input type="text" placeholder="登录ID" id="loginID" minlength="8" maxlength="64" name="loginID"
											class="form-control" check-type="required" value="${data.loginID }">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5 ">
										<label class="checkbox-inline"> <input type="radio" name="sex" value="M" <c:if test="${data.sex == 'M'}">checked="checked"</c:if> > 男 </label> 
										<label class="checkbox-inline"> <input type="radio" name="sex" value="F" <c:if test="${data.sex == 'F'}">checked="checked"</c:if> > 女 </label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5 ">
										<label class="checkbox-inline"> 
											<input type="radio" name="status" value="1" <c:if test="${data.status == 1}">checked="checked"</c:if> > 有效
										</label> 
										<label class="checkbox-inline"> 
											<input type="radio" name="status" value="0" <c:if test="${data.status == 0}">checked="checked"</c:if>> 无效
										</label>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input type="text" placeholder="生日" name="birthday" id="birthday" class="form-control date"
											onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" value="<fmt:formatDate value="${data.birthday}" type="date"></fmt:formatDate>">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" placeholder="选择组织" id="organName" class="form-control" value="${data.organs[0].name }" readonly="readonly">
										<input type="hidden" name="organs[0].organCode" value="${data.organs[0].organCode }" id="organCode" >
									</div>
									<div class="col-sm-1">
