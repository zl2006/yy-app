					...
					<div class="page-header">
						...
						<div class="bs-example" style="content:">
							<form role="form" class="form-horizontal"
								action="${basePath }/role/update.json?resID=${param.resID}" method="post" id="save_update_form">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" name="roleCode"  class="form-control"  value="${data.role.roleCode }" readonly="readonly">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										<input type="hidden" value="${data.system.systemCode }" name="systemCode" id="systemCode">
									</div>
									<div class="col-sm-1">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" placeholder="请输入角色名称" id="name" maxlength="64" name="name"
											class="form-control" check-type="required" value="${data.role.name }">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<textarea rows="5" cols="3" placeholder="描述" name="description"
											id="description" class="form-control" maxlength="255">${data.role.description}</textarea>
									</div>
								</div>
								<div class="form-group">
