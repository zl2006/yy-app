				...
				<div class="bs-docs-section">
					<div class="page-header">
						...
						<div class="bs-example" style="content:">
							<form role="form" class="form-horizontal" action="${basePath }/resource/save.json?resID=${param.resID}"
								...
								<div class="form-group">
									...
									<div class="col-sm-8 ">
										<label class="checkbox-inline">
											<input type="radio" name="type" value="0" checked="checked"> 菜单（模块）
										</label>
										<label class="checkbox-inline"> 
											<input type="radio" name="type" value="1"> 模块通用操作
										</label>
										<label class="checkbox-inline"> 
											<input type="radio" name="type" value="2"> 模块列表操作
										</label>
										<label class="checkbox-inline"> 
											<input type="radio" name="type" value="3"> 其它操作
										</label>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										<input type="hidden" name="parentResID" id="parentResID" value="${data.parentRes.parentResID }">
									</div>
									<div class="col-sm-1">
