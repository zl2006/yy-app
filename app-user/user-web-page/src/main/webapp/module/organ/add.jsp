					...
					<div class="page-header">
						...
						<div class="bs-example" style="content:">
							<form role="form" class="form-horizontal"
								action="${basePath }/organ/save.json?resID=${param.resID}"
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" placeholder="请输入组织机构编号" id="organCode" maxlength="32" name="organCode"
											class="form-control" check-type="required" value="${data.organ.organCode }">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" placeholder="第二负责人" name="secondPrincipal" id="secondPrincipal"
											class="form-control" maxlength="64" value="${data.secondPrincipal}">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" placeholder="传真" name="fax" id="fax"
											class="form-control" maxlength="32" value="${data.fax}">
									</div>
								</div>
								<div class="form-group">
