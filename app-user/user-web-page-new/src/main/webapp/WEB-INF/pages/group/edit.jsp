                ...
                <div class="pure-form pure-form-aligned form">
                    <div class="form-area">
                       ...
                       <div class="pure-control-group">
                            <label>用户组名称:</label>
                            <input  name="groupName" type="text"  data-rule="required;length[~64]" class="pure-u-1-5" value="${data.groupName }">
                        </div>
                         <div class="pure-control-group">
                            <label>描述:</label>
                            <textarea rows="5" cols="45"  name="description"  data-rule="length[~255]">${data.description}</textarea>
                        </div>
                    </div>
                </div><!-- pure-form -->
                <div class="form-oper">
