...
public class OrganServiceImpl implements OrganService {
    ...
    public Organ insertOrgan(Organ organ) 
    	...
    	//数据验证
        List<ValidateError> errors = ValidateUtil.validate(organ);
        if (errors.size() > 0) {
    ...
    /** {@inheritDoc} */
    @Override
	public Organ findOrgan(String organCode) throws ServiceException {
		if (StringUtils.isEmpty(organCode)) {
            throw new ServiceException("ORGAN_CODE_EMPTY", "组织机构编码为空");
        }
    ...
    */
    ...
    private void validateOrgan(Organ organ)throws ServiceException{
    	//当父组织机构为空时，设置层顶级组织机构
    ...
    private void resetHasChild(String organCode)throws ServiceException{
